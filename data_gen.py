...
data = [
    ...
    (63, "A recipe calls for 1.5 cups of sugar. If you want to make half the recipe, how much sugar do you need?", "Sugar needed = 1.5 ÷ 2 = 0.75 cups"),
    ...
    (97, "A ladder is 10 m long and leans against a wall. If the base is 6 m from the wall, how high does the ladder reach?", "Height² + 6² = 10² → Height² = 64 → Height = 8 m"),
...
df = pd.DataFrame(data, columns=["problem_id", "problem_text", "solution_text"])
df.to_csv("word_problems.csv", index=False)